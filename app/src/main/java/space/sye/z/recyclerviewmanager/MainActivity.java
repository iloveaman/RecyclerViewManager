...
//                })
                .setOnItemClickListener(new RefreshRecyclerViewAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(RecyclerView.ViewHolder holder, int position) {
                        Toast.makeText(MainActivity.this, "onItemClick item" + position, Toast.LENGTH_SHORT).show();
                    }
                })
                .setOnItemLongClickListener(new RefreshRecyclerViewAdapter.OnItemLongClickListener() {
                    ...
                    public boolean onItemLongCLick(RecyclerView.ViewHolder holder, int position) {
                        Toast.makeText(MainActivity.this, "onItemLongCLick item" + position, Toast.LENGTH_SHORT).show();
                        return false;
                    }
                })
